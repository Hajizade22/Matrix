...
public class Hangman {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Sizin qarşınızda duran məqsəd əfsanə " + ANSI_RED + "Milan" + ANSI_RESET + " kadrosunun ilk" +
                " 11-ə daxil olan oyunçulardan random olaraq birinin adını tapmaq");
        String[] words = {"Dida", "Cafu", "Nesta", "Stam", "Maldini", "Pirlo", "Gattuso", "Seedorf", "Kaka", "Inzaghi",
                "Shevchenko"};
        ...
        while (min < max && new String(letters).contains("_") && !new String(letters).equals(rand)) {
